...
const parameterValidator = __webpack_require__(71);
const Logger = __webpack_require__(72);
const uuid = __webpack_require__(30);
const Promise = __webpack_require__(4);
const operators  = __webpack_require__(5);
const operatorsArray = _.values(operators);
const primitives = ['string', 'number', 'boolean'];

let inflection = __webpack_require__(76);
...
const _ = __webpack_require__(0);
const Wkt = __webpack_require__(62);
const sequelizeErrors = __webpack_require__(3);
const warnings = {};
const Validator = __webpack_require__(15).validator;
const momentTz = __webpack_require__(17);
...
DataTypes.postgres = __webpack_require__(65)(DataTypes);
DataTypes.mysql = __webpack_require__(68)(DataTypes);
DataTypes.sqlite = __webpack_require__(69)(DataTypes);
DataTypes.mssql = __webpack_require__(70)(DataTypes);
...
const Promise = __webpack_require__(75).getNewLibraryCopy();
...
const Sequelize = __webpack_require__(27);
const log = __webpack_require__(34).log;
exports.sequilize = new Sequelize('postgres://qnsfwisi:Jt9VsRBpStZtyHLz8uqjykqhr1WUE--_@elmer.db.elephantsql.com:5432/qnsfwisi');
exports.sequilize.authenticate()
    .then(() => {
...
const Utils = __webpack_require__(1);
const Helpers = __webpack_require__(18);
const _ = __webpack_require__(0);
const Transaction = __webpack_require__(19);
const Association = __webpack_require__(7);
...
const _ = __webpack_require__(0);
const validator = _.cloneDeep(__webpack_require__(64));
const moment = __webpack_require__(16);
...
const Pooling = __webpack_require__(90);
const Promise = __webpack_require__(4);
const _ = __webpack_require__(0);
const Utils = __webpack_require__(1);
...
const QueryTypes = __webpack_require__(10);
...
const Utils = __webpack_require__(1);
const SqlString = __webpack_require__(29);
const Model = __webpack_require__(37);
const DataTypes = __webpack_require__(2);
const util = __webpack_require__(6);
const _ = __webpack_require__(0);
...
const Association = __webpack_require__(7);
const BelongsTo = __webpack_require__(12);
const BelongsToMany = __webpack_require__(20);
const HasMany = __webpack_require__(13);
const Op = __webpack_require__(5);
const uuid = __webpack_require__(30);
const semver = __webpack_require__(14);
...
const QueryGenerator = {
  _templateSettings: __webpack_require__(0).runInContext().templateSettings,
  options: {},
...
module.exports = {"name":"api-nodewebpack","version":"0.1.0","description":"node webpack api","main":"./dist/server.js","scripts":{"build":"webpack --config webpack.config.js","pm2":"pm2 start ./dist/server.js","postinstall":"npm run build","test":"jest --forceExit","test-ci":"npm test && cat ./coverage/lcov.info | coveralls","start":" npm run build && node ./dist/server.js","production":" npm run build && node ./dist/server.js","qa":" npm run build && node ./dist/server.js"},"repository":{"type":"git","url":""},"author":"Jaspal Singh","license":"MIT","bugs":{"url":""},"homepage":"","jest":{"globals":{"ts-jest":{"tsConfigFile":"tsconfig.json"}},"moduleFileExtensions":["ts","js","json"],"moduleDirectories":["node_modules","server"],"transform":{"^.+\\.(ts|tsx)$":"./node_modules/ts-jest/preprocessor.js"},"testMatch":["**/tests/**/*.test.(ts|js)"],"testEnvironment":"node","mapCoverage":true,"collectCoverage":true,"collectCoverageFrom":["**/*.{ts,jsx}","!**/node_modules/**","!**/vendor/**","!**/coverage/**","!**/webpack.config.js"]},"engines":{"node":"9.2.0"},"devDependencies":{"@types/body-parser":"^1.16.4","@types/chai":"^4.0.1","@types/dotenv":"^4.0.0","@types/express":"^4.0.36","@types/jest":"^20.0.4","@types/joi":"^13.0.5","@types/nconf":"0.0.34","@types/node":"^8.0.13","@types/pg":"^7.4.8","@types/sequelize":"^4.27.16","@types/supertest":"^2.0.2","@types/winston":"^2.3.9","chai":"^4.1.0","coveralls":"^3.0.0","jest":"^21.2.1","mocha":"^4.0.1","supertest":"^3.0.0","ts-jest":"^21.2.4","ts-loader":"^3.2.0","ts-node":"^3.2.0","tslint":"^5.8.0","typescript":"^2.6.2","webpack":"^3.9.1"},"dependencies":{"bcrypt":"^2.0.1","body-parser":"^1.17.2","chai-http":"^4.0.0","cors":"^2.8.4","dotenv":"^4.0.0","express":"^4.16.2","joi":"^13.1.2","jsonwebtoken":"^8.2.1","morgan":"^1.9.0","mysql2":"^1.5.3","nconf":"^0.8.5","pg":"^7.4.1","pg-hstore":"^2.3.2","pm2":"^2.7.1","sequelize":"^4.37.6","sqlite3":"^4.0.0","tedious":"^2.3.1","webpack-cli":"^2.1.2","winston":"^2.4.2","xlsx-to-json":"^0.3.0"}}
...
const hstore = __webpack_require__(66)({sanitize: true});
...
Object.defineProperty(exports, "__esModule", { value: true });
const winston = __webpack_require__(53);
...
const BelongsTo = __webpack_require__(12);
const BelongsToMany = __webpack_require__(20);
const InstanceValidator = __webpack_require__(77);
const QueryTypes = __webpack_require__(10);
const sequelizeErrors = __webpack_require__(3);
const Dottie = __webpack_require__(32);
const Promise = __webpack_require__(4);
...
const HasMany = __webpack_require__(13);
const DataTypes = __webpack_require__(2);
const Hooks = __webpack_require__(38);
const associationsMixin = __webpack_require__(78);
...
const _ = __webpack_require__(0);
const Utils = __webpack_require__(1);
const AbstractQueryGenerator = __webpack_require__(25);
const util = __webpack_require__(6);
const Op = __webpack_require__(5);
...
function onError(res, message, error) {
    console.error("Promise Error", message, error);
    res.status(500).send();
}
...
Object.defineProperty(exports, "__esModule", { value: true });
var xlsxj = __webpack_require__(115);
const result = xlsxj({
    input: "./test.xlsx",
    output: "output.json",
}, function (err, result) {
...
var obj = __webpack_require__(116);
let studs = [];
for (let i = 0; i < obj.length; i++) {
    studs[i] = {
        familyId: obj[i].familyId,
        children: {
            id: obj[i].studentId,
            fName: obj[i].fName,
            mName: obj[i].mName,
            lName: obj[i].lName,
            registrationYear: obj[i].registrationYear,
            khalsaschool: obj[i].khalsaschool,
            kirtan: obj[i].kirtan,
            dateofBirth: obj[i].dateofBirth,
            age: obj[i].age,
            gender: obj[i].gender,
            publicSchoolGrade: obj[i].publicSchoolGrade,
            ClassAllocation2016: obj[i].ClassAllocation2016,
            CurrentClassAllocated: obj[i].CurrentClassAllocated,
            newClassAllocation: obj[i].newClassAllocation,
            child1EnrolledAlready: obj[i].child1EnrolledAlready,
            registrationfor2016and2017: obj[i].registrationfor2016and2017,
            specialNeedsChild: obj[i].specialNeedsChild,
            tantisaaj: obj[i].tantisaaj,
            tabla: obj[i].tabla,
            harmonium: obj[i].harmonium
        },
        parent: {
            pfName: obj[i].pfName,
            pmName: obj[i].pmName,
            plName: obj[i].plName,
            firstEmail: obj[i].firstEmail,
            secondaryEmail: obj[i].secondaryEmail,
            phone1: obj[i].phone1,
            phone2: obj[i].phone2,
            isPaymenetSubmited: obj[i].isPaymenetSubmited,
            selectedFeesName: obj[i].selectedFeesName,
            amountType: obj[i].amountType,
            bankName: obj[i].bankName,
            checkNumber: obj[i].checkNumber,
            receiptNumber: obj[i].receiptNumber,
            feesAmount: obj[i].feesAmount,
            paymenet: obj[i].paymenet,
            ...
            RecordCreatedDate: obj[i].RecordCreatedDate
        }
    };
}
exports.default = studs;
...
Object.defineProperty(exports, "__esModule", { value: true });
const db = __webpack_require__(9);
const Sequelize = __webpack_require__(27);
exports.admin = db.sequilize.define('admins', {
    id: {
        primaryKey: true,
...
Object.defineProperty(exports, "__esModule", { value: true });
let jwt = __webpack_require__(47);
...
const db = __webpack_require__(9);
const Sequelize = __webpack_require__(27);
exports.teacher = db.sequilize.define('teachers', {
    id: {
        primaryKey: true,
        type: Sequelize.INTEGER,
        unique: true,
...
const dotenv = __webpack_require__(50);
const bodyParser = __webpack_require__(51);
const homeController = __webpack_require__(52);
const logger_1 = __webpack_require__(34);
const db = __webpack_require__(9);
const studentRouter_1 = __webpack_require__(54);
const parentRouter_1 = __webpack_require__(117);
const errorHandler_1 = __webpack_require__(120);
const adminController = __webpack_require__(121);
const loginController = __webpack_require__(122);
const teacherController = __webpack_require__(123);
const result = __webpack_require__(44);
var cors = __webpack_require__(124);
dotenv.config();
const app = express();
app.use(cors());
const port = process.env.PORT || 3000;
var whitelist = ['http://localhost:8100', 'http://appnextgen.com'];
var corsOptions = {
...
let studRouter = new studentRouter_1.StudentRouter();
let parentRouter = new parentRouter_1.ParentsRouter();
...
app.use('/api/v1/students', studRouter.router, cors(corsOptions));
app.use('/api/v1/parents', cors(corsOptions), parentRouter.router);
app.use('/api/admin', cors(corsOptions), adminRoutes.router);
app.use('/api/login', cors(corsOptions), loginRoutes.router);
app.use('/api/teacher', cors(corsOptions), teacherRoutes.router);
app.use(errorHandler_1.errorHandeler);
app.listen(app.get('port'), () => {
    console.log(('App is running at http://localhost:%d in %s mode'), app.get('port'), app.get('env'));
    console.log('Press CTRL-C to stop\n');
    logger_1.log.info(`Express server listening on port ${port}.\nEnvironment: ${process.env.NODE_ENV}`);
});
module.exports = app;
...
Object.defineProperty(exports, "__esModule", { value: true });
let pkg = __webpack_require__(26);
...
const studentController_1 = __webpack_require__(55);
class StudentRouter {
    constructor() {
        this.studController = new studentController_1.studentController();
        this.router = express_1.Router();
        this.routes();
    }
    routes() {
        this.router.get('/', this.studController.getStudents);
        this.router.post('/', this.studController.createStudent);
        this.router.get('/:id', this.studController.getStudentById);
        this.router.delete('/:id', this.studController.deleteStudentById);
        this.router.post('/bulk', this.studController.insertBulkStudents);
        this.router.get('/getByName/:fname/:lname', this.studController.getStudentByName);
        this.router.put('/:id', this.studController.updateStudent);
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
const _ = __webpack_require__(0);
const student = __webpack_require__(56);
const onError_1 = __webpack_require__(42);
const onSuccess_1 = __webpack_require__(43);
var studs = __webpack_require__(44);
class studentController {
    constructor() {
    }
    getStudents(req, res) {
        console.log(JSON.stringify(studs));
        student.default().findAll()
            .then(_.partial(onSuccess_1.onSuccess, res))
            .catch(_.partial(onError_1.onError, res, "Get Students Failed"));
    }
    getStudentById(req, res) {
        student.default().find({
            where: {
                familyId: req.params.id
            }
        })
            .then(_.partial(onSuccess_1.onSuccess, res))
            .catch(_.partial(onError_1.onError, res, "Get Students By Id Failed"));
    }
    createStudent(req, res) {
        student.default().create(req.body)
            .then(() => res.status(200).send("Data Inserted Successfully"))
            .catch(_.partial(onError_1.onError, res, "create Students Failed"));
    }
    deleteStudentById(req, res) {
        student.default().destroy({
            where: {
                id: req.params.id
            }
        })
            .then(() => res.status(200).send("Record deleted Successfully"))
            .catch(_.partial(onError_1.onError, res, "Delete Students By Id Failed"));
    }
    insertBulkStudents(req, res) {
        student.default().bulkCreate(studs.default, { returning: true })
            .then(_.partial(onSuccess_1.onSuccess, res))
            .catch(_.partial(onError_1.onError, res, "Get Students By Id Failed"));
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
const ORM = __webpack_require__(35);
const sequelize = new ORM('postgres://qnsfwisi:Jt9VsRBpStZtyHLz8uqjykqhr1WUE--_@elmer.db.elephantsql.com:5432/qnsfwisi');
exports.default = () => {
    const student = sequelize.define('students', {
        children: ORM.ARRAY({ type: ORM.JSON }),
        familyId: {
            type: ORM.INTEGER,
            primaryKey: true,
            autoIncrement: true
...
const clsBluebird = __webpack_require__(61);
const Utils = __webpack_require__(1);
const Model = __webpack_require__(37);
const DataTypes = __webpack_require__(2);
const Deferrable = __webpack_require__(80);
const ModelManager = __webpack_require__(81);
const QueryInterface = __webpack_require__(83);
const Transaction = __webpack_require__(19);
const QueryTypes = __webpack_require__(10);
const TableHints = __webpack_require__(39);
const sequelizeErrors = __webpack_require__(3);
const Promise = __webpack_require__(4);
const Hooks = __webpack_require__(38);
const Association = __webpack_require__(87);
const Validator = __webpack_require__(15).validator;
const _ = __webpack_require__(0);
const Op = __webpack_require__(5);
...
class Sequelize {
  ...
  constructor(database, username, password, options) {
    ...
    switch (this.getDialect()) {
      case 'mssql':
        Dialect = __webpack_require__(88);
        break;
      case 'mysql':
        Dialect = __webpack_require__(96);
        break;
      case 'postgres':
        Dialect = __webpack_require__(101);
        break;
      case 'sqlite':
        Dialect = __webpack_require__(107);
        break;
      default:
 ...
 */
Sequelize.version = __webpack_require__(114).version;
...
const _ = __webpack_require__(0);
const wkx = __webpack_require__(36);
const inherits = __webpack_require__(11);
...
module.exports = BaseTypes => {
  ...
  const range = __webpack_require__(67);
...
const depd = __webpack_require__(73),
  debug = __webpack_require__(74),
...
const validator = __webpack_require__(15).validator;
const extendModelValidations = __webpack_require__(15).extendModelValidations;
const Utils = __webpack_require__(1);
...
const Toposort = __webpack_require__(82);
const _ = __webpack_require__(0);
...
const _ = __webpack_require__(0);
const DataTypes = __webpack_require__(2);
const SQLiteQueryInterface = __webpack_require__(84);
const MSSSQLQueryInterface = __webpack_require__(85);
const MySQLQueryInterface = __webpack_require__(86);
const Transaction = __webpack_require__(19);
const Promise = __webpack_require__(4);
const QueryTypes = __webpack_require__(10);
const Op = __webpack_require__(5);
...
Association.BelongsToMany = __webpack_require__(20);
...
const _ = __webpack_require__(0);
const AbstractDialect = __webpack_require__(21);
const ConnectionManager = __webpack_require__(89);
const Query = __webpack_require__(93);
const QueryGenerator = __webpack_require__(94);
...
const AbstractConnectionManager = __webpack_require__(22);
const ResourceLock = __webpack_require__(91);
const Promise = __webpack_require__(4);
const Utils = __webpack_require__(1);
...
const sequelizeErrors = __webpack_require__(3);
const parserStore = __webpack_require__(23)('mssql');
const _ = __webpack_require__(0);
  ...
  constructor(dialect, sequelize) {
    ...
    try {
      if (sequelize.config.dialectModulePath) {
        ...
        this.lib = __webpack_require__(40);
      }
    } catch (err) {
...
const Promise = __webpack_require__(4);
const AbstractQuery = __webpack_require__(24);
const sequelizeErrors = __webpack_require__(3);
const parserStore = __webpack_require__(23)('mssql');
const _ = __webpack_require__(0);
const TYPES = __webpack_require__(40).TYPES;
...
const TableHints = __webpack_require__(39);
const AbstractQueryGenerator = __webpack_require__(25);
const randomBytes = __webpack_require__(95).randomBytes;
const semver = __webpack_require__(14);
...
const _ = __webpack_require__(0);
const AbstractDialect = __webpack_require__(21);
const ConnectionManager = __webpack_require__(97);
const Query = __webpack_require__(100);
const QueryGenerator = __webpack_require__(41);
  ...
  constructor(dialect, sequelize) {
    ...
    try {
      if (sequelize.config.dialectModulePath) {
        ...
        this.lib = __webpack_require__(99);
      }
    } catch (err) {
      if (err.code === 'MODULE_NOT_FOUND') {
...
const _ = __webpack_require__(0);
const AbstractDialect = __webpack_require__(21);
const ConnectionManager = __webpack_require__(102);
const Query = __webpack_require__(105);
const QueryGenerator = __webpack_require__(106);
...
const _ = __webpack_require__(0);
const AbstractDialect = __webpack_require__(21);
const ConnectionManager = __webpack_require__(108);
const Query = __webpack_require__(111);
const QueryGenerator = __webpack_require__(112);
...
const dataTypes = __webpack_require__(2).sqlite;
const sequelizeErrors = __webpack_require__(3);
const parserStore = __webpack_require__(23)('sqlite');
  ...
  constructor(dialect, sequelize) {
    ...
    try {
      if (sequelize.config.dialectModulePath) {
        ...
        this.lib = __webpack_require__(110).verbose();
      }
    } catch (err) {
      if (err.code === 'MODULE_NOT_FOUND') {
...
const Transaction = __webpack_require__(19);
const _ = __webpack_require__(0);
const MySqlQueryGenerator = __webpack_require__(41);
const AbstractQueryGenerator = __webpack_require__(25);
...
module.exports = {"_args":[["sequelize@4.37.6","/Users/jaspalkamboj/Documents/khalsashcool/khalsaSchool-Api"]],"_from":"sequelize@4.37.6","_id":"sequelize@4.37.6","_inBundle":false,"_integrity":"sha512-x/6099L+6+3LQWms23wng/AR6yUE3X/VhrwSTSMbgOIk2ELY3DchI/9f9Ii7LIQRPxW1BHGpwboH7kxS/froXg==","_location":"/sequelize","_phantomChildren":{"ms":"2.0.0"},"_requested":{"type":"version","registry":true,"raw":"sequelize@4.37.6","name":"sequelize","escapedName":"sequelize","rawSpec":"4.37.6","saveSpec":null,"fetchSpec":"4.37.6"},"_requiredBy":["/"],"_resolved":"https://registry.npmjs.org/sequelize/-/sequelize-4.37.6.tgz","_spec":"4.37.6","_where":"/Users/jaspalkamboj/Documents/khalsashcool/khalsaSchool-Api","author":{"name":"Sascha Depold","email":"sascha@depold.com"},"bugs":{"url":"https://github.com/sequelize/sequelize/issues"},"config":{"commitizen":{"path":"./node_modules/cz-conventional-changelog"}},"contributors":[{"name":"Sascha Depold","email":"sascha@depold.com"},{"name":"Jan Aagaard Meier","email":"janzeh@gmail.com,jmei@itu.dk"},{"name":"Daniel Durante","email":"me@danieldurante.com"},{"name":"Mick Hansen","email":"mick.kasper.hansen@gmail.com"},{"name":"Sushant Dhiman","email":"sushantdhiman@outlook.com"}],"dependencies":{"bluebird":"^3.5.0","cls-bluebird":"^2.1.0","debug":"^3.1.0","depd":"^1.1.0","dottie":"^2.0.0","generic-pool":"^3.4.0","inflection":"1.12.0","lodash":"^4.17.1","moment":"^2.20.0","moment-timezone":"^0.5.14","retry-as-promised":"^2.3.2","semver":"^5.5.0","terraformer-wkt-parser":"^1.1.2","toposort-class":"^1.0.1","uuid":"^3.2.1","validator":"^9.4.1","wkx":"^0.4.1"},"description":"Multi dialect ORM for Node.JS","devDependencies":{"chai":"^4.1.2","chai-as-promised":"^7.1.1","chai-datetime":"^1.5.0","chai-spies":"^1.0.0","cheerio":"^1.0.0-rc.2","commitizen":"^2.9.6","continuation-local-storage":"^3.2.0","cross-env":"^5.0.5","cz-conventional-changelog":"^2.0.0","env-cmd":"^7.0.0","esdoc":"^0.5.2","eslint":"^4.16.0","eslint-plugin-mocha":"^4.11.0","hints":"^1.1.0","husky":"^0.14.2","istanbul":"^0.4.5","lcov-result-merger":"^2.0.0","mocha":"^5.0.4","mysql2":"^1.x","pg":"^7.x","pg-hstore":"^2.3.2","pg-native":"^2.x","pg-types":"^1.x","rimraf":"^2.5.4","semantic-release":"^15.0.0","sinon":"^4.3.0","sinon-chai":"^2.14.0","sqlite3":"^3.x","tedious":"1.14.0","uuid-validate":"^0.0.2","validate-commit-msg":"^2.12.2"},"engines":{"node":">=4.0.0"},"homepage":"https://github.com/sequelize/sequelize#readme","keywords":["mysql","sqlite","postgresql","postgres","mssql","orm","nodejs","object relational mapper"],"license":"MIT","main":"index","name":"sequelize","options":{"env_cmd":"./test/config/.docker.env","mocha":"--globals setImmediate,clearImmediate --ui tdd --exit --check-leaks --colors -t 30000 --reporter spec"},"publishConfig":{"tag":"latest"},"release":{"branch":"v4","verifyConditions":["@semantic-release/npm","@semantic-release/github"]},"repository":{"type":"git","url":"git+https://github.com/sequelize/sequelize.git"},"scripts":{"commitmsg":"validate-commit-msg","cover":"rimraf coverage && npm run teaser && npm run cover-integration && npm run cover-unit && npm run merge-coverage","cover-integration":"cross-env COVERAGE=true ./node_modules/.bin/istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly -- -t 30000 --exit --ui tdd \"test/integration/**/*.test.js\" && node -e \"require('fs').renameSync('coverage/lcov.info', 'coverage/integration.info')\"","cover-unit":"cross-env COVERAGE=true ./node_modules/.bin/istanbul cover ./node_modules/mocha/bin/_mocha --report lcovonly -- -t 30000 --exit --ui tdd \"test/unit/**/*.test.js\" && node -e \"require('fs').renameSync('coverage/lcov.info', 'coverage/unit.info')\"","docs":"esdoc && cp docs/ROUTER esdoc/ROUTER","lint":"eslint lib test --quiet","merge-coverage":"lcov-result-merger \"coverage/*.info\" \"coverage/lcov.info\"","semantic-release":"semantic-release","sscce":"env-cmd $npm_package_options_env_cmd node sscce.js","sscce-mysql":"cross-env DIALECT=mysql npm run sscce","sscce-postgres":"cross-env DIALECT=postgres npm run sscce","sscce-sqlite":"cross-env DIALECT=sqlite npm run sscce","teaser":"node -e \"console.log('#'.repeat(process.env.DIALECT.length + 22) + '\\n# Running tests for ' + process.env.DIALECT + ' #\\n' + '#'.repeat(process.env.DIALECT.length + 22))\"","test":"npm run teaser && npm run test-unit && npm run test-integration","test-all":"npm run test-mysql && npm run test-sqlite && npm run test-postgres && npm run test-postgres-native && npm run test-mssql","test-docker":"npm run test-docker-unit && npm run test-docker-integration","test-docker-integration":"env-cmd $npm_package_options_env_cmd npm run test-integration","test-docker-unit":"npm run test-unit","test-integration":"mocha $npm_package_options_mocha \"test/integration/**/*.test.js\"","test-integration-all":"npm run test-integration-mysql && npm run test-integration-postgres && npm run test-integration-postgres-native && npm run test-integration-mssql && npm run test-integration-sqlite","test-integration-mssql":"cross-env DIALECT=mssql npm run test-integration","test-integration-mysql":"cross-env DIALECT=mysql npm run test-integration","test-integration-postgres":"cross-env DIALECT=postgres npm run test-integration","test-integration-postgres-native":"cross-env DIALECT=postgres-native npm run test-integration","test-integration-sqlite":"cross-env DIALECT=sqlite npm run test-integration","test-mssql":"cross-env DIALECT=mssql npm test","test-mysql":"cross-env DIALECT=mysql npm test","test-pgsql":"npm run test-postgres","test-postgres":"cross-env DIALECT=postgres npm test","test-postgres-native":"cross-env DIALECT=postgres-native npm test","test-postgresn":"npm run test-postgres-native","test-sqlite":"cross-env DIALECT=sqlite npm test","test-unit":"mocha $npm_package_options_mocha \"test/unit/**/*.js\"","test-unit-all":"npm run test-unit-mysql && npm run test-unit-postgres && npm run test-unit-postgres-native && npm run test-unit-mssql && npm run test-unit-sqlite","test-unit-mssql":"cross-env DIALECT=mssql npm run test-unit","test-unit-mysql":"cross-env DIALECT=mysql npm run test-unit","test-unit-postgres":"cross-env DIALECT=postgres npm run test-unit","test-unit-postgres-native":"cross-env DIALECT=postgres-native npm run test-unit","test-unit-sqlite":"cross-env DIALECT=sqlite npm run test-unit"},"version":"4.37.6"}

/***/ }),
/* 115 */
/***/ (function(module, exports) {

module.exports = require("xlsx-to-json");

/***/ }),
/* 116 */
/***/ (function(module, exports) {

module.exports = [{"TempClassAllocation":"","familyId":"1001","studentId":"10011","fName":"Aashna","mName":"K","lName":"Soni","registrationYear":"2016","khalsaschool":"TRUE","kirtan":"TRUE","dateofBirth":"1/15/07","age":"8","gender":"Female","publicSchoolGrade":"4","ClassAllocation2016":"","CurrentClassAllocated":"L2-A","newClassAllocation":"","child1EnrolledAlready":"TRUE","registrationfor2016and2017":"TRUE","specialNeedsChild":"","tantisaaj":"TRUE","tabla":"","harmonium":"TRUE","pfName":"Tejvansh","pmName":"S","plName":"Soni","firstEmail":"Tejvansh@gmail.com","secondaryEmail":"","phone1":"510-894-4478","phone2":"","isPaymenetSubmited":"yes","selectedFeesName":"Pending","amountType":"Check","bankName":"","checkNumber":"121","receiptNumber":"66727","feesAmount":"200","paymenet":"Pay Now","comments":"online only cs","address1":"34445 Valley Oaks Loop","address2":"","city":"Union City","state":"CA","zipCode":"94587","RecordCreatedDate":"8/19/2016, 1:53:38 PM"},{"TempClassAllocation":"","familyId":"1002","studentId":"10021","fName":"Avineet","mName":"","lName":"Ghai","registrationYear":"","khalsaschool":"","kirtan":"","dateofBirth":"","age":"","gender":"Female","publicSchoolGrade":"","ClassAllocation2016":"","CurrentClassAllocated":"","newClassAllocation":"","child1EnrolledAlready":"","registrationfor2016and2017":"","specialNeedsChild":"","tantisaaj":"","tabla":"","harmonium":"","pfName":"Inderjit","pmName":"S","plName":"Ghai","firstEmail":"tanuGhai@yahoo","secondaryEmail":"","phone1":"","phone2":"","isPaymenetSubmited":"","selectedFeesName":"Pending","amountType":"","bankName":"","checkNumber":"","receiptNumber":"","feesAmount":"","paymenet":"","comments":"","address1":"330 Lower Vintners Cir","address2":"","city":"Fremont","state":"CA","zipCode":"94539","RecordCreatedDate":""},{"TempClassAllocation":"","familyId":"1002","studentId":"10022","fName":"Jasleen","mName":"","lName":"Ghai","registrationYear":"","khalsaschool":"","kirtan":"","dateofBirth":"","age":"","gender":"Female","publicSchoolGrade":"","ClassAllocation2016":"","CurrentClassAllocated":"","newClassAllocation":"","child1EnrolledAlready":"","registrationfor2016and2017":"","specialNeedsChild":"","tantisaaj":"","tabla":"","harmonium":"","pfName":"Inderjit","pmName":"S","plName":"Ghai","firstEmail":"tanuGhai@yahoo","secondaryEmail":"","phone1":"","phone2":"","isPaymenetSubmited":"","selectedFeesName":"Pending","amountType":"","bankName":"","checkNumber":"","receiptNumber":"","feesAmount":"","paymenet":"","comments":"","address1":"330 Lower Vintners Cir","address2":"","city":"Fremont","state":"CA","zipCode":"94539","RecordCreatedDate":""},{"TempClassAllocation":"","familyId":"1003","studentId":"10031","fName":"Gurman","mName":"K","lName":"Khaira","registrationYear":"","khalsaschool":"","kirtan":"","dateofBirth":"9/14/09","age":"5","gender":"Female","publicSchoolGrade":"","ClassAllocation2016":"","CurrentClassAllocated":"Kinder-B","newClassAllocation":"","child1EnrolledAlready":"","registrationfor2016and2017":"","specialNeedsChild":"","tantisaaj":"","tabla":"","harmonium":"","pfName":"Jatinder","pmName":"","plName":"Singh","firstEmail":"jnkhaira@aol.com","secondaryEmail":"","phone1":"","phone2":"","isPaymenetSubmited":"","selectedFeesName":"Pending","amountType":"","bankName":"","checkNumber":"","receiptNumber":"","feesAmount":"","paymenet":"","comments":"","address1":"3272 San Andreas Dr","address2":"","city":"Union City","state":"CA","zipCode":"94587","RecordCreatedDate":""},{"TempClassAllocation":"","familyId":"1004","studentId":"10041","fName":"Gurmehar","mName":"K","lName":"Bains","registrationYear":"","khalsaschool":"","kirtan":"","dateofBirth":"","age":"","gender":"Female","publicSchoolGrade":"","ClassAllocation2016":"","CurrentClassAllocated":"","newClassAllocation":"","child1EnrolledAlready":"","registrationfor2016and2017":"","specialNeedsChild":"","tantisaaj":"","tabla":"","harmonium":"","pfName":"Mandeep","pmName":"","plName":"Bains","firstEmail":"mandeepbains@yahoo.com","secondaryEmail":"","phone1":"","phone2":"","isPaymenetSubmited":"","selectedFeesName":"Pending","amountType":"","bankName":"","checkNumber":"","receiptNumber":"","feesAmount":"","paymenet":"","comments":"","address1":"424 Emerson St","address2":"","city":"Fremont","state":"CA","zipCode":"94539","RecordCreatedDate":""}]
...
Object.defineProperty(exports, "__esModule", { value: true });
const express_1 = __webpack_require__(8);
const parentsController_1 = __webpack_require__(118);
class ParentsRouter {
    constructor() {
        this.parentController = new parentsController_1.parentsController();
        this.router = express_1.Router();
        this.routes();
    }
    routes() {
        this.router.get('/', this.parentController.getParents);
        this.router.post('/', this.parentController.createParent);
        this.router.get('/:id', this.parentController.getParentById);
        this.router.delete('/:id', this.parentController.deleteParentById);
    }
}
exports.ParentsRouter = ParentsRouter;
...
Object.defineProperty(exports, "__esModule", { value: true });
const _ = __webpack_require__(0);
const parent = __webpack_require__(119);
const onError_1 = __webpack_require__(42);
const onSuccess_1 = __webpack_require__(43);
class parentsController {
    ...
    getParents(req, res) {
        parent.default().findAll()
            .then(_.partial(onSuccess_1.onSuccess, res))
            .catch(_.partial(onError_1.onError, res, "Get Parents Failed"));
    }
    getParentById(req, res) {
        parent.default().findById(req.params.id)
            .then(_.partial(onSuccess_1.onSuccess, res))
            .catch(_.partial(onError_1.onError, res, "Get Parent By Id Failed"));
    }
    createParent(req, res) {
        parent.default().create(req.body)
            .then(() => res.status(200).send("Data Inserted Successfully"))
            .catch(_.partial(onError_1.onError, res, "create Parent Failed"));
    }
    deleteParentById(req, res) {
        parent.default().destroy({
            where: {
                id: req.params.id
            }
        })
            .then(() => res.status(200).send("Record deleted Successfully"))
            .catch(_.partial(onError_1.onError, res, "Delete Parent By Id Failed"));
    }
}
...
function errorHandeler(error, req, res, next) {
    console.error("API ERROR HANDLER TRIGERED", error);
    res.status(500).json({
        errorCode: 'ERR-001',
...
Object.defineProperty(exports, "__esModule", { value: true });
const express_1 = __webpack_require__(8);
const admin_1 = __webpack_require__(45);
let pkg = __webpack_require__(26);
const db = __webpack_require__(9);
const bcrypt = __webpack_require__(33);
const verifyToken_1 = __webpack_require__(46);
class adminRouter {
    constructor() {
        this.router = express_1.Router();
        this.routes();
    ...
    create(req, res) {
        ...
        bcrypt.hash(description.password, bcryptHashNumber, (err, hash) => {
            if (err) {
                console.log(err);
            }
            else {
                description.password = hash;
                admin_1.admin.create({ description })
                    .then((data) => {
                    res.status(200).json({ data });
                })
                    .catch((error) => {
    ...
    update(req, res) {
        ...
        admin_1.admin.update({ description }, { where: { id: id } }).then((data) => {
            res.status(200).json({ data });
        })
            .catch((error) => {
            res.status(500).json({ error });
    ...
    routes() {
        this.router.get('/', verifyToken_1.default, this.getAll);
        this.router.get('/:id', verifyToken_1.default, this.getOne);
        this.router.post('/', verifyToken_1.default, this.create);
        this.router.delete('/:id', verifyToken_1.default, this.delete);
        this.router.patch('/update/:id', verifyToken_1.default, this.update);
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
const express_1 = __webpack_require__(8);
const jwt = __webpack_require__(47);
const db = __webpack_require__(9);
const admin_1 = __webpack_require__(45);
const teacher_1 = __webpack_require__(48);
const bcrypt = __webpack_require__(33);
class loginRouter {
    constructor() {
        this.router = express_1.Router();
    ...
    allAdmin(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let user = yield admin_1.admin.findOne({
                where: {
                    description: {
                        email: email
                    }
            ...
            let passwordIsValid = yield bcrypt.compareSync(password, user.description.password);
            if (!passwordIsValid) {
            ...
            var token = yield jwt.sign({ user: user }, 'secret', {
                expiresIn: 86400
            }, (err, token) => {
                res.json({
                    token: token,
    ...
    allTeachers(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            let email = req.body.email;
            let password = req.body.password;
            let teachers = yield teacher_1.teacher.findOne({
                where: {
                    description: {
                        email: email
                    }
            ...
            let passwordIsValid = yield bcrypt.compareSync(password, teachers.description.password);
            if (!passwordIsValid) {
                return res.status(401).send({
                    auth: false,
                    token: null
            ...
            var token = yield jwt.sign({ teachers: teachers }, 'secret', {
                expiresIn: 86400
            }, (err, token) => {
                res.json({
                    token: token,
...
class teacherRouter {
    ...
    create(req, res) {
        ...
        bcrypt.hash(description.password, bcryptHashNumber, (err, hash) => {
            if (err) {
                ...
                description.password = hash;
                teacher_1.teacher.create({ description })
                    .then((data) => {
                    res.status(200).json({ data });
                })
                    .catch((error) => {
    ...
    update(req, res) {
        const id = req.params.id;
        const description = req.body.description;
        teacher_1.teacher.update({ description }, { where: { id: id } }).then((data) => {
            res.status(200).json({ data });
        })
            .catch((error) => {
            res.status(500).json({ error });
